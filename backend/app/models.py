...
class AuditAction(str, Enum):
    ...
    FAILED_ADMIN_PAGE_ACCESS = "FAILED_ADMIN_PAGE_ACCESS"
    FAILED_MANAGER_PAGE_ACCESS = "FAILED_MANAGER_PAGE_ACCESS"
    FAILED_EMPLOYEE_PAGE_ACCESS = "FAILED_EMPLOYEE_PAGE_ACCESS"
    INC_CHAR_EMAIL = "INC_CHAR_EMAIL"
    INC_NICKNAME = "INC_NICKNAME"
    OUT_OF_RANGE_NN = "OUT_OF_RANGE_NN"
    INC_CHAR_PASS = "INC_CHAR_PASS"
    NO_DIGIT_PASS = "NO_DIGIT_PASS"
    OUT_OF_RANGE_PASS = "OUT_OF_RANGE_PASS"
